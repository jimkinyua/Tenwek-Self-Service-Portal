    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <h3 class="card-title">PIP Appraisal - CEO  List  &nbsp;    <?php Html::a('<i class="fa fa-plus-square"></i> Add New Appraisal',['create'],['class' => 'add-objective btn btn-outline-info btn-sm']) ?></h3>
        ...
        var absolute = $('input[name=absolute]').val();
         ...
         $.fn.dataTable.ext.errMode = 'throw';
          ...
          $('#appraisal').DataTable({
            ...
            //serverSide: true,  
            ajax: absolute+'probation/ceoprobationlist',
            paging: true,
            columns: [
